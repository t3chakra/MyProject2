...
int main()
{
  int i,c,v,flag,v1,v2,v3,v4,v5,v6,graphcount=0,r,flag2;
	char** tokens;
	char* token; 
	char** edge;
	char buffer[2500];	
...
/********************************************Printing result**************************************************/				  
					...
					qsort (res1,v,sizeof(int), compare);
				  	...
				  	while(res1[i]!=INF)
				  	{ 
				   	 	fprintf(stdout,"%d ",res1[i]);
				    		i++;
				  	}size2=i-1;
                                  	fprintf(stdout,"\n");
                                  	qsort (res2,v,sizeof(int), compare);
                                  	fprintf(stdout,"REFINED-APPROX-VC-1: ");
                                  	i=0;
			          	while(res2[i]!=INF)
				  	{ 
				    		i++;
					...
					fprintf(stdout,"\n");
				  	...
				  	qsort (res4,v,sizeof(int), compare);
                                  	fprintf(stdout,"REFINED-APPROX-VC-2: ");
					i=0;
